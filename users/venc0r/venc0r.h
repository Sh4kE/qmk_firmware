 ...
 * |     |  q  |  w  |  f  |  p  |  b  |                    |  j  |  l  |  u  |  z  |  ;  | ä   |
 * |-----+-----+-----+-----+-----+-----|                    |-----+-----+-----+-----+-----+-----|
 * | ESC | w^a | a^r | c^s | s^t |  g  |                    |  m  | s^n | c^e | a^i | w^o | ü   |
 * |-----+-----+-----+-----+-----+-----+-----.        ,-----+-----+-----+-----+-----+-----+-----|
...
#define _______________S_COLEMAK_L2________________       KC_ESC,  C_HOME_A, C_HOME_R, C_HOME_S, C_HOME_T, KC_G
#define _______________S_COLEMAK_L3________________       KC_TAB,  KC_Y,     KC_X,     KC_C,     KC_D,     KC_V,     KC_MUTE
#define __S_THUMB_L____                                       KC_LGUI, KC_LALT, LCTL_T(KC_TAB), RAISE, SFT_T(KC_SPC)
...
#define _______________S_COLEMAK_R2________________                   KC_M,  C_HOME_N, C_HOME_E, C_HOME_I, C_HOME_O, KC_RALT
#define _______________S_COLEMAK_R3________________       _______,    KC_K,  KC_H,     KC_COMM,  KC_DOT,   KC_SLASH, KC_QUOT
#define __S_THUMB_R____                                   SFT_T(KC_BSPC), LOWER, LCTL_T(KC_ENT), KC_RALT, KC_RGUI
...
#define _______________S_SYMBOL_L1_________________       _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5
#define _______________S_SYMBOL_L2_________________       _______, KC_DLR,  KC_PLUS, KC_LPRN, KC_RPRN, KC_AT
#define _______________S_SYMBOL_L3_________________       _______, KC_EXLM, KC_HASH, KC_LCBR, KC_RCBR, KC_TILD, _______

#define _______________S_SYMBOL_R0_________________                _______, _______, _______, _______, _______, _______
#define _______________S_SYMBOL_R1_________________                KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______
#define _______________S_SYMBOL_R2_________________                KC_PIPE, KC_MINS, KC_EQL,  KC_UNDS, KC_ASTR, _______
#define _______________S_SYMBOL_R3_________________       _______, KC_AMPR, KC_LBRC, KC_RBRC, KC_PERC, KC_CIRC, _______
 ...
 * |     |     |     |     |     |     |                      |     |     |     |     |     |     |
 * |-----+-----+-----+-----+-----+-----|                      |-----+-----+-----+-----+-----+-----|
 * |     |     |Word |     |     |Back |                      |Down |Right|  ü  |     |     |     |
 * |-----+-----+-----+-----+-----+-----|                      |-----+-----+-----+-----+-----+-----|
 * |     |  ä  |Home |PGUP |PGDN | End |                      |     |     |ENDW |     |  ö  |     |
 * |-----+-----+-----+-----+-----+-----+-----.          ,-----|-----+-----+-----+-----+-----+-----|
 * |     |     |     |BspW |DelW | Del |     |          |     | Up  |Left |     |     |     |     |
 * `-----------------------------------------'          `-----`-----------------------------------'
 */
...
#define _______________S_NAV_L2____________________       _______, RALT(KC_Q), KC_HOME, KC_PGUP,    KC_PGDN,    KC_END
...
#define _______________S_NAV_R1____________________                KC_DOWN, KC_RGHT, RALT(KC_Y), _______, _______, _______
#define _______________S_NAV_R2____________________                _______, _______, ENDW,    _______, RALT(KC_P), _______
