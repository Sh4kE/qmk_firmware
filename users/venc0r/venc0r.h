...
#define __S_THUMB_L____                                       KC_LGUI, LALT_T(KC_ESC), LCTL_T(KC_TAB), RAISE, SFT_T(KC_SPC)

#define _______________S_COLEMAK_R0________________                   KC_6,  KC_7,     KC_8,     KC_9,     KC_0,     ALGR(KC_P)
#define _______________S_COLEMAK_R1________________                   KC_J,  KC_L,     KC_U,     KC_Z,     KC_SCLN,  ALGR(KC_Q)
#define _______________S_COLEMAK_R2________________                   KC_M,  C_HOME_N, C_HOME_E, C_HOME_I, C_HOME_O, ALGR(KC_Y)
#define _______________S_COLEMAK_R3________________       _______,    KC_K,  KC_H,     KC_COMM,  KC_DOT,   KC_SLASH, KC_QUOT
#define __S_THUMB_R____                                   SFT_T(KC_BSPC), LOWER, LCTL_T(KC_ENT), RALT_T(KC_ESC), KC_RGUI
