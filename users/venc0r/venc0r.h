 ...
 * `-----------------------------'        `-----------------------------'
 */
#define _________________SYMBOL_L1_________________       KC_GRV,  DEGREE,  KC_LBRC, KC_RBRC, KC_DLR
#define _________________SYMBOL_L2_________________       KC_ESC,  KC_PLUS, KC_LPRN, KC_RPRN, KC_AT
#define _________________SYMBOL_L3_________________       KC_TAB,  KC_HASH, KC_LCBR, KC_RCBR, KC_TILD
